...
format:
  html:
    ...
    css: styles.css
    code-fold: true
    code-summary: "View Analysis Code"
---

<div class="github-link">
GitHub Repository: <a href="https://github.com/ElizabethEro/Legal-Matter-Duration-Analysis.git">Legal-Matter-Duration-Analysis</a>
</div>
...
This suggests systemic inefficiencies such as:
- incomplete or ambiguous initial instructions from business stakeholders  
...
This suggests a reinforcing operational loop:
- more revisions → more stakeholder interaction  
...
**Business interpretation:**  
This reflects structural inefficiencies associated with external counsel engagement, including:
- additional communication layers between internal and external teams  
...
### 3. Complexity Score (Not statistically significant)
...
Instead, complexity likely affects duration indirectly by increasing the likelihood of:
...
### 4. Approval Layers (Not statistically significant)
